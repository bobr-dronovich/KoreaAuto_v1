...
// Dataset of ready-to-go Korean cars formatted in WestMotors style
    ...
    if (carForm) {
        carForm.addEventListener("submit", async (e) => {
            ...
            const carData = {
                ...
                daysOnSale: "2 дня в продаже",
                imageUrl: imgInput.value.trim() || "logos/KoreaAuto_logo.png",
